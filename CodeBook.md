CodeBook for module 3 of the Coursera data-science specialisation ('Gathering and Cleaning Data')
-------------------------------------------------------------------------------------------------

The script performs the following tranformations/manipulations/calculations...
...
10) Exports the data as a text file ('module3.txt')
...
The original experimental notes for this data-set is as follows (stripped-down for this module),
